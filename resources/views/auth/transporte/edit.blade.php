  ...
  <form action="{{ route('UpdateTransporte', $transporte->id) }}" method="post">
    ...
    <div class="col-lg-offset-3 col-lg-6">
      <div class="form-group">
        ...
        <input type="radio" required name="tipo" value='Interno'<?php if($transporte->tipo == 'Interno') echo 'checked' ?>> Interno<br>
        <input type="radio" required name="tipo" value='Externo'<?php if($transporte->tipo == 'Externo') echo 'checked' ?>> Externo<br>
        ...
        <input type="text" name="imagem" pattern="https{0,1}://i.imgur.com/.*|https{0,1}://imgur.com/.*" placeholder="http://imgur.com/..." class="form-control"
               value='{{$transporte->imagem}}' required>
