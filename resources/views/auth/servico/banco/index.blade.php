        ...
        <tr>
          ...
          <td>
            <form action="{{ route('DestroyServicoBanco', $banco->id) }}" method="post">
              ...
              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal-{{$banco->id}}">
                Excluir
              </button>

              <div class="modal fade" id="myModal-{{$banco->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
