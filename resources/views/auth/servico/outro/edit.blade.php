  ...
  <form action="{{ route('UpdateServicoOutro', $outro->id) }}" method="post">
    ...
    <div class="col-lg-offset-3 col-lg-6">
      <div class="form-group">
        ...
        <input type="text" name="nome" placeholder="Digite o nome que identificará o servico" class="form-control" value="{{$servico->nome}}">

        <label for="servico">Tipo de Serviço</label>
        <input type="text" name="servico" placeholder="Digite qual o serviço prestado" class="form-control" value="{{$outro->servico}}">
