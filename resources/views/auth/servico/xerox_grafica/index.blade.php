        ...
        <tr>
          ...
          <td>
            <form action="{{ route('DestroyServicoXeroxGrafica', $xerox_grafica->id) }}" method="post">
              ...
              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal-{{$xerox_grafica->id}}">
                Excluir
              </button>

              <div class="modal fade" id="myModal--{{$xerox_grafica->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      Confirme que deseja excluir {{App\ServicoXeroxGrafica::getXeroxGraficaNome($xerox_grafica->id)}}.
                      <p class="aviso">
