  ...
  <form action="{{ route('UpdateServicoComercio', $comercio->id) }}" method="post">
    ...
    <div class="col-lg-offset-3 col-lg-6">
      <div class="form-group">
        ...
        <input type="text" name="imagem" pattern="https{0,1}://i.imgur.com/.*|https{0,1}://imgur.com/.*" placeholder="http://imgur.com/..." class="form-control" value='{{$servico->imagem}}' require>
