        ...
        <tr>
          ...
          <td>
            <form action="{{ route('DestroyTipoDeComida', $comida->id) }}" method="post">
              ...
              <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal-{{$comida->id}}">
                Excluir
              </button>

              <div class="modal fade" id="myModal-{{$comida->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
